...
The [Summarize2](https://npm.im/jsdoc-summarize2) plugin changes some tags of the comment block according to a simple set of rules.
...
If you also want to uninstall [JSDoc](https://npm.im/jsdoc):
